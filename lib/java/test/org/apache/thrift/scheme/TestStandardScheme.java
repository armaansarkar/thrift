...
public class TestStandardScheme extends SchemeTestBase {
  
  TSerializer serializer = new TSerializer();
  TDeserializer deserializer = new TDeserializer();
  
  /** 
   * This tests whether the Standard Scheme properly reads structs 
   * serialized using an older version of thrift.
   */
