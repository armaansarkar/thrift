...
public class Fixtures {
  ...
  // They were serialized using thrift 0.6.x and are used to test
  // backwards compatibility with respect to the standard scheme.
  ...
  static {
    try {
      ...
      persistentBytesOneOfEach = new byte[] { (byte) 0x02, (byte) 0x00,
      ...
      persistentBytesHolyMoley = new byte[] { (byte) 0x0F, (byte) 0x00,
      ...
      persistentBytesNesting = new byte[] { (byte) 0x0C, (byte) 0x00,
